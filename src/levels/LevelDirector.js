...
const CASTLE_TIMELINE = [
  ...
  { time: 12.5, lane: 1, symbols: [SYMBOLS.N], speed: 48 },
  ...
  { time: 26.0, lane: 3, symbols: [SYMBOLS.N, SYMBOLS.DOWN], speed: 38, radius: 29, score: 180 },
  ...
  { time: 46.0, lane: 3, symbols: [SYMBOLS.RIGHT, SYMBOLS.N], speed: 46, radius: 27, score: 190 },
  ...
  { time: 60.0, lane: 4, symbols: [SYMBOLS.LEFT, SYMBOLS.RIGHT, SYMBOLS.N, SYMBOLS.LEFT, SYMBOLS.RIGHT, SYMBOLS.N], speed: 26, radius: 42, score: 500, kind: 'boss' }
];
...
const OCEAN_TIMELINE = [
  ...
  { time: 10.0, lane: 0, species: 'pufferfish', symbols: [SYMBOLS.N, SYMBOLS.RIGHT], speed: 48, radius: 28, score: 180 },
  ...
  { time: 30.2, lane: 3, species: 'pufferfish', symbols: [SYMBOLS.N, SYMBOLS.V], speed: 54, radius: 29, score: 210 },
  ...
  { time: 43.2, lane: 3, species: 'shark', symbols: [SYMBOLS.N, SYMBOLS.DOWN], speed: 62, radius: 30, score: 230 },
  ...
  { time: 54.5, lane: 1, species: 'pufferfish', symbols: [SYMBOLS.RIGHT, SYMBOLS.N], speed: 67, radius: 28, score: 230 },
  { time: 60.0, lane: 4, species: 'megalodon', symbols: [SYMBOLS.LEFT, SYMBOLS.RIGHT, SYMBOLS.V, SYMBOLS.N, SYMBOLS.LEFT, SYMBOLS.RIGHT, SYMBOLS.V, SYMBOLS.N], speed: 32, radius: 48, score: 700, kind: 'boss' }
];
...
const PENGUIN_HOTEL_TIMELINE = [
  ...
  { time: 8.5, lane: 0, species: 'penguinBellhop', symbols: [SYMBOLS.N, SYMBOLS.CIRCLE], speed: 55, radius: 28, score: 220 },
  ...
  { time: 25.7, lane: 3, species: 'penguinBellhop', symbols: [SYMBOLS.N, SYMBOLS.V, SYMBOLS.CIRCLE], speed: 62, radius: 30, score: 300 },
  ...
  { time: 36.7, lane: 3, species: 'penguinChef', symbols: [SYMBOLS.CIRCLE, SYMBOLS.N, SYMBOLS.DOWN], speed: 71, radius: 31, score: 330 },
  ...
  { time: 46.3, lane: 1, species: 'penguinBellhop', symbols: [SYMBOLS.RIGHT, SYMBOLS.CIRCLE, SYMBOLS.N], speed: 77, radius: 29, score: 340 },
  { time: 51.0, lane: 4, species: 'emperorPenguin', symbols: [SYMBOLS.CIRCLE, SYMBOLS.CIRCLE, SYMBOLS.LEFT, SYMBOLS.RIGHT, SYMBOLS.V, SYMBOLS.N, SYMBOLS.CIRCLE, SYMBOLS.DOWN, SYMBOLS.CIRCLE, SYMBOLS.UP], speed: 37, radius: 50, score: 1000, kind: 'boss' }
];
...
const DINOSAUR_PARK_TIMELINE = [
  ...
  { time: 8.5, lane: 0, species: 'triceratops', symbols: [SYMBOLS.N, SYMBOLS.CIRCLE], speed: 59, radius: 28, score: 260 },
  ...
  { time: 25.7, lane: 3, species: 'pterosaur', symbols: [SYMBOLS.N, SYMBOLS.V, SYMBOLS.CIRCLE], speed: 66, radius: 30, score: 340 },
  ...
  { time: 36.7, lane: 3, species: 'brachiosaurus', symbols: [SYMBOLS.Z, SYMBOLS.N, SYMBOLS.DOWN], speed: 75, radius: 31, score: 370 },
  ...
  { time: 46.3, lane: 1, species: 'brachiosaurus', symbols: [SYMBOLS.RIGHT, SYMBOLS.CIRCLE, SYMBOLS.N], speed: 81, radius: 29, score: 380 },
  { time: 51.0, lane: 4, species: 'tyrannosaurus', symbols: [SYMBOLS.Z, SYMBOLS.CIRCLE, SYMBOLS.RIGHT, SYMBOLS.LEFT, SYMBOLS.V, SYMBOLS.N, SYMBOLS.Z, SYMBOLS.DOWN, SYMBOLS.CIRCLE, SYMBOLS.UP, SYMBOLS.Z, SYMBOLS.CIRCLE], speed: 41, radius: 54, score: 1300, kind: 'boss' }
];
